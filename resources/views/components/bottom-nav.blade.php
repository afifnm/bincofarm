...
if ($user->isPjGh()) {
    $links = [
        ...
        ['route' => 'profil', 'label' => 'Profil', 'icon' => $iconProfil],
    ];
} else {
    $links = [
        ['route' => 'dashboard', 'label' => 'Beranda', 'icon' => $iconBeranda],
